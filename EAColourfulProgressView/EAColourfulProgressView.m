...
- (void)setupBackgroundView
{
    ...
    [self.backgroundView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(@(self.backgroundViewHeight));
...
- (void)setupFillingView
{
    ...
    [self.fillingView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.backgroundView).offset(self.borderLineWidth);
        make.height.equalTo(@(self.fillingViewHeight));
        make.left.equalTo(self.backgroundView).offset(self.borderLineWidth);
        make.width.equalTo(@(self.fillingViewWidth));
    }];
...
- (void)setupInitialLabel
{
    ...
    [self.initialLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self).offset(EAColourfulProgressViewTopMargin);
        make.left.equalTo(self);
...
- (void)setupFinalLabel
{
    ...
    [self.finalLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self).offset(EAColourfulProgressViewTopMargin);
        make.left.greaterThanOrEqualTo(self.initialLabel);
...
- (void)updateToCurrentValue:(NSInteger)currentValue animated:(BOOL)animated
{
    ...
    CGFloat width1 = ceilf((self.backgroundView.bounds.size.width - borders) * self.fractionLeft);
    
    [self.fillingView mas_updateConstraints:^(MASConstraintMaker *make) {
